...
pub struct RevealToAuditor<'info> {
    ...
    #[account(address = derive_comp_def_pda!(COMP_DEF_OFFSET_REVEAL_TO_AUDITOR))]
...
#[callback_accounts("reveal_to_auditor")]
#[derive(Accounts)]
...
#[init_computation_definition_accounts("reveal_to_auditor", payer)]
#[derive(Accounts)]
pub struct InitRevealToAuditorCompDef<'info> {
    #[account(mut)]
    pub payer: Signer<'info>,
