...
export type Veilpay = {
  ...
  "metadata": {
    ...
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "VeilPay MPC | confidential payments with Arcium"
  },
  "instructions": [
    {
      "name": "batchTransfer",
    ...
    {
      "name": "initDebitFromAccountCompDef",
      "discriminator": [
        5,
        141,
        244,
    ...
    {
      "name": "initDepositToAccountCompDef",
      "discriminator": [
        23,
        73,
        161,
    ...
    {
      "name": "initProveThresholdCompDef",
      "discriminator": [
        170,
        113,
        77,
    ...
    {
      "name": "initRevealAccountBalanceCompDef",
      "discriminator": [
        190,
        152,
        216,
    ...
    {
      "name": "initRevealToAuditorCompDef",
      "discriminator": [
        230,
        223,
        57,
    ...
    {
      "name": "initTransferBetweenAccountsCompDef",
      "discriminator": [
        144,
        219,
        88,
    ...
    {
      "name": "initWithdrawFromAccountCompDef",
      "discriminator": [
        5,
        59,
        157,
    ...
    {
      "name": "revealAccountBalanceCallback",
      "discriminator": [
        163,
        107,
        117,
              ...
              "generics": [
                {
                  ...
                  "type": {
                    "defined": {
                      "name": "revealAccountBalanceOutput"
                    }
                  }
                }
              ]
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "ciphertextReceiverBalance",
          "type": {
            "array": [
              "u8",
              32
    ...
    {
      "name": "transferBetweenAccountsCallback",
      "discriminator": [
        155,
        143,
        165,
              ...
              "generics": [
                {
                  ...
                  "type": {
                    "defined": {
                      "name": "transferBetweenAccountsOutput"
                    }
                  }
                }
              ]
    ...
    {
      "name": "withdrawFromAccountCallback",
      "discriminator": [
        117,
        27,
        107,
              ...
              "generics": [
                {
                  ...
                  "type": {
                    "defined": {
                      "name": "withdrawFromAccountOutput"
                    }
                  }
                }
              ]
  ...
  "events": [
    {
      "name": "accountBalanceRevealedEvent",
      "discriminator": [
        35,
        7,
        155,
        ...
        "fields": [
          {
            ...
            "type": {
              "defined": {
                "name": "transferBetweenAccountsOutputStruct0"
              }
            }
          }
        ]
        ...
        "fields": [
          {
            ...
            "type": {
              "defined": {
                "name": "withdrawFromAccountOutputStruct0"
              }
            }
          }
        ]
