...
/**
 * ReactBits "Dither" — dithered Perlin/fbm wave background (WebGL).
 * Source mirrored from react-bits (MIT), typed for TS and rendered client-only.
 */
...
const RetroEffect = forwardRef<any, { colorNum: number; pixelSize: number }>((props, ref) => {
  return <WrappedRetro ref={ref as any} colorNum={props.colorNum} pixelSize={props.pixelSize} />;
});
